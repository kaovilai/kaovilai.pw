<template>
  <div class="hello">
    ...
    <h2>Social</h2>
    <div class="devicon">
      <a href="mailto:passawit.kaovilai@gmail.com"><i title="Email" class="devicon-google-plain colored"></i></a>
    ...
    <h2>My Toolbox</h2>
      <div class="introArea">
        ...
        <div class="skillbox">
          <h3><typing-component text="UI Frameworks"/></h3>
          <div class="devicon">
...
<svg style="width:fit-content; margin: 0 -100px;" version="1.0" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
...
.devicon {
  --sidemargin: 15px;
  font-size: 4em;
  filter: drop-shadow(1.1px 1.1px 1.1px grey);
}
.devicon svg {
  max-height: 1em;
  width: auto;

<template>
  <div class="hello">
    ...
    <div class="displayArea">
      <div class="introArea">
        ...
        <div class="devicon">
          <i title="vuejs" class="devicon-vuejs-plain-wordmark colored"></i>
        </div>
        <h3><typing-component text="Clouds"/></h3>
        <div class="devicon">
          <i title="googlecloud" class="devicon-googlecloud-plain-wordmark"></i>
          <i title="amazonwebservices" class="devicon-amazonwebservices-plain-wordmark"></i>
  ...
  <g>
    ...
    <h2><typing-component text="Essential Links"/></h2>
    <!-- <ul>
      <li>
        <a
    ...
    <h2><typing-component text="Projects"/></h2>
    <!-- <ul>
      <li>
        <a
...
.devicon {
  --sidemargin: 15px;
  font-size: 4em;
  filter: drop-shadow(2px 2px 10px var(--NCSU_Pyroman_Flame));
}
.devicon svg {
  max-height: 1em;
  width: auto;
